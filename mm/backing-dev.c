...
static void bdi_thread_init(struct backing_dev_info *bdi,
			    struct bdi_writeback *wb)
{
...
static int bdi_start_fn(void *ptr)
{
	...
	bdi_thread_init(bdi, wb);

	ret = bdi_writeback_thread(wb);
...
static int bdi_forker_thread(void *ptr)
{
	...
	for (;;) {
		...
		case FORK_THREAD:
			__set_current_state(TASK_RUNNING);
			task = kthread_create(bdi_start_fn, &bdi->wb,
